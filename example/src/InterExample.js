...
const InterExample = ({ adUnitId, isInitialized, log }) => {
    ...
    const setupEventListeners = () => {
        ...
        InterstitialAd.addAdLoadFailedEventListener((errorInfo) => {
        ...
        InterstitialAd.addAdRevenuePaidListener((adInfo) => {
    ...
    return (_jsx(AppButton, { title: getInterstitialButtonTitle(), enabled: isInitialized && adLoadState !== AdLoadState.loading, onPress: async () => {
            try {
